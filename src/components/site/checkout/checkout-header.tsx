  ...
  return (
    <header className="border-b border-site-border bg-site-bg">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <SiteLink href="/" prefetch={prefetchLinks} className="flex min-w-0 items-center gap-2.5">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-site-primary text-sm font-bold text-white">
            {siteName.slice(0, 1).toUpperCase()}
          </span>
          <span className="truncate text-base font-semibold tracking-tight text-site-fg">
            {siteName}
          </span>
        </SiteLink>
