...
import { getCachedProjectCategoryIndex, projectCategoryHref } from "@/lib/projects";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPublicMetadata({
    settings,
    ...PUBLIC_HUB_SEO.projectCategories,
  });
}
...
export default async function ProjectCategoriesIndexPage() {
  ...
  const hub = PUBLIC_HUB_SEO.projectCategories;
      ...
      <section className="relative overflow-hidden border-b border-site-border bg-site-surface py-14">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-site-muted">
            Çalışma alanlarımıza göre tamamladığımız projeleri keşfedin.
          </p>
        </div>
      </section>
