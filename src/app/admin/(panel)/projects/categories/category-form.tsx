...
const initialState: ProjectCategoryFormState = {};
...
export function ProjectCategoryForm({ mode, initial, parentOptions = [] }: ProjectCategoryFormProps) {
  const router = useRouter();
  const action = mode === "create" ? createProjectCategoryAction : updateProjectCategoryAction;
      ...
      <section className="rounded-lg border border-[#e9ebec] bg-white shadow-sm">
        <div className="border-b border-[#e9ebec] px-5 py-4">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Proje kategorisinin adı, kısa açıklaması ve yayın durumu
          </p>
        </div>
        ...
        <div className="grid gap-5 p-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="Örn. Kurumsal Web, Mobil Uygulama"
          ...
          <div className="md:col-span-2">
            ...
            <RichTextEditor
              ...
              placeholder="Kartlarda görünecek kısa proje açıklaması"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <RichTextEditor
              ...
              placeholder="Proje kategorisinin detaylı açıklaması, proje detayları vb."
            />
          </div>
        </div>
      </section>
