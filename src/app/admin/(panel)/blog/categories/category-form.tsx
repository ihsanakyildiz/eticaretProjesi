...
const initialState: BlogCategoryFormState = {};
...
export function BlogCategoryForm({ mode, initial, parentOptions = [] }: BlogCategoryFormProps) {
  const router = useRouter();
  const action = mode === "create" ? createBlogCategoryAction : updateBlogCategoryAction;
      ...
      <section className="rounded-lg border border-[#e9ebec] bg-white shadow-sm">
        <div className="border-b border-[#e9ebec] px-5 py-4">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Blog kategorisinin adı, kısa açıklaması ve yayın durumu
          </p>
        </div>
        ...
        <div className="grid gap-5 p-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <RichTextEditor
              ...
              placeholder="Kartlarda görünecek kısa kategori açıklaması"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <RichTextEditor
              ...
              placeholder="Blog kategorisinin detaylı açıklaması vb."
            />
          </div>
        </div>
      </section>
