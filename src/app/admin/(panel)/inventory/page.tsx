...
export default async function InventoryStockPage({ searchParams }: StockPageProps) {
  ...
  const emptyColSpan = 4 + warehouses.length + (warehouseId ? 1 : 0);
    ...
    <div className="space-y-6">
      <div className="rounded-lg border border-[#e9ebec] bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 max-w-3xl text-sm text-slate-500">
          {advancedInventory
            ? "Bu sayfa yalnızca depo (satılabilir) stoğunu gösterir. Tedarikçi stoğu burada yer almaz; ürün kartında bilgi amaçlıdır ve feed stok limitiyle satışa aç/kapa için kullanılır."
