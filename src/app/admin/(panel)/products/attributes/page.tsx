...
import { ProductAttributesTable } from "./attributes-table";

export const metadata: Metadata = {
  title: "Varyant özellikleri",
  description: "Ürün beden, renk ve diğer SKU eksenlerini yönetin",
};
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 flex items-center gap-2 text-xl font-semibold text-slate-800 sm:text-2xl">
              <SwatchBook className="h-6 w-6 text-[#405189]" />
              Varyant özellikleri
            </h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-500">
              Beden, renk gibi seçenekler burada tanımlanır. Satın alınan birim ve stok,
              ürün kaydındaki her SKU (varyant) satırındadır — değerin kendisinde değil.
            </p>
          </div>
