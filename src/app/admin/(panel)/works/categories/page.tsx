...
import { WorkCategoriesTable } from "./categories-table";

export const metadata: Metadata = {
  title: "Hizmet Kategorileri",
  description: "Yapılan işler / hizmet kategorilerini yönetin",
};
...
export default async function WorkCategoriesPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-500">
              Ana ve alt kategorilerle hizmet ağacınızı yönetin. Her satırdaki + ile sınırsız alt
      ...
      <WorkCategoriesTable categories={categories} categoryOptions={categoryOptions} />
    </div>
  );
}
