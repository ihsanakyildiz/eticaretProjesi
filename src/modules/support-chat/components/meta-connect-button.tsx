export function SupportChatMetaConnectButton({ configured }: { configured: boolean }) {
  return (
    <div className="rounded-lg border border-[#e9ebec] bg-white p-5 shadow-sm">
      ...
      {configured ? (
        <a
          href="/api/support-chat/meta/start"
          className="mt-4 inline-flex items-center gap-2 rounded-md bg-[#1877F2] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#166fe5]"
        >
